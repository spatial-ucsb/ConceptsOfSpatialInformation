...
class TestGeoTiffField(unittest.TestCase):
    ...
    def test_local( self ):
        ...
        dem = getTestField()
        newGtiffPath = os.path.join("..","data","fields","testLocal.tif")
    ...
    def test_focal( self ):
        ...
        dem = getTestField()
        newGtiffPath = os.path.join("..","data","fields","testFocal.tif")
    ...
    def test_zonal( self ):
        ...
        newGtiffPath = os.path.join("..","data","fields","testZonal.tif")
        dem = getTestField()
